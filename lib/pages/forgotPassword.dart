...
import '../widgets/widgets.dart'; // Ensure this includes your showSnackbar function
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: const Size.fromHeight(50.0), // Increase AppBar height
        child: AppBar(
          leading: IconButton(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16.0),
                    Image.asset(
                      'assets/Security.png', // Ensure the path is correct
                      height: 150,
                    ),
                    const SizedBox(height: 16.0),
                    ElevatedButton(
